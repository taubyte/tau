...
func (client *Client) Lock(jid string, eta uint32) error {
	if _, err := client.client.Send("patrick", streams.Body{"action": "lock", "jid": jid, "eta": eta}); err != nil {
...
func (client *Client) IsLocked(jid string) (bool, error) {
	resp, err := client.client.Send("patrick", streams.Body{"action": "isLocked", "jid": jid})
	if err != nil {
...
func (client *Client) Unlock(jid string) error {
	if _, err := client.client.Send("patrick", streams.Body{"action": "unlock", "jid": jid}); err != nil {
...
func (client *Client) Done(jid string, cid_log map[string]string, assetCid map[string]string) error {
	if _, err := client.client.Send("patrick", streams.Body{"action": "done", "jid": jid, "cid": cid_log, "assetCid": assetCid}); err != nil {
...
func (client *Client) Failed(jid string, cid_log map[string]string, assetCid map[string]string) error {
	if _, err := client.client.Send("patrick", streams.Body{"action": "failed", "jid": jid, "cid": cid_log, "assetCid": assetCid}); err != nil {
...
func (client *Client) Cancel(jid string, cid_log map[string]string) (interface{}, error) {
	resp, err := client.client.Send("patrick", streams.Body{"action": "cancel", "jid": jid, "cid": cid_log})
	if err != nil {
...
func (client *Client) List() ([]string, error) {
	resp, err := client.client.Send("patrick", streams.Body{"action": "list", "jid": ""})
	if err != nil {
...
func (client *Client) Timeout(jid string) error {
	if _, err := client.client.Send("patrick", streams.Body{"action": "timeout", "jid": jid}); err != nil {
...
func (client *Client) Get(jid string) (*iface.Job, error) {
	var job iface.Job
	resp, err := client.client.Send("patrick", streams.Body{"action": "info", "jid": jid})
	if err != nil {
		return nil, fmt.Errorf("failed sending list with error: %w", err)
	}
