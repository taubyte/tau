# config-compiler — the legacy compiler, kept as a conformance oracle
...
output against the old one and prove they agree. See `../README.md` for what the
`parity/` tree as a whole is for.
