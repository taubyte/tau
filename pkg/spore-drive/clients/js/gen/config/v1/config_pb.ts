...
/**
 * @generated from message config.v1.UInt64Op
 */
export class UInt64Op extends Message<UInt64Op> {
  /**
   * @generated from oneof config.v1.UInt64Op.op
   */
  op: {
    /**
     * @generated from field: uint64 set = 1;
     */
    value: bigint;
    case: "set";
  } | {
  ...
  constructor(data?: PartialMessage<UInt64Op>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "config.v1.UInt64Op";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "set", kind: "scalar", T: 4 /* ScalarType.UINT64 */, oneof: "op" },
    { no: 2, name: "get", kind: "scalar", T: 8 /* ScalarType.BOOL */, oneof: "op" },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UInt64Op {
    return new UInt64Op().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UInt64Op {
    return new UInt64Op().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UInt64Op {
    return new UInt64Op().fromJsonString(jsonString, options);
  }

  static equals(a: UInt64Op | PlainMessage<UInt64Op> | undefined, b: UInt64Op | PlainMessage<UInt64Op> | undefined): boolean {
    return proto3.util.equals(UInt64Op, a, b);
  }
}
...
export class Op extends Message<Op> {
  ...
  op: {
    ...
    /**
     * @generated from field: config.v1.Accounts accounts = 6;
     */
    value: Accounts;
    case: "accounts";
  } | { case: undefined; value?: undefined } = { case: undefined };
 ...
 * Accounts
 *
 * @generated from message config.v1.Accounts
 */
export class Accounts extends Message<Accounts> {
  /**
   * @generated from oneof config.v1.Accounts.op
   */
  op: {
    /**
     * @generated from field: config.v1.StringOp session_ttl = 1;
     */
    value: StringOp;
    case: "sessionTtl";
  } | {
    /**
     * @generated from field: config.v1.AccountsEmail email = 2;
     */
    value: AccountsEmail;
    case: "email";
  } | { case: undefined; value?: undefined } = { case: undefined };
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "config.v1.Accounts";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "session_ttl", kind: "message", T: StringOp, oneof: "op" },
    { no: 2, name: "email", kind: "message", T: AccountsEmail, oneof: "op" },
  ]);
...
/**
 * @generated from message config.v1.AccountsEmail
 */
export class AccountsEmail extends Message<AccountsEmail> {
  /**
   * @generated from oneof config.v1.AccountsEmail.op
   */
  op: {
    /**
     * @generated from field: config.v1.SMTP smtp = 1;
     */
    value: SMTP;
    case: "smtp";
  } | { case: undefined; value?: undefined } = { case: undefined };

  constructor(data?: PartialMessage<AccountsEmail>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "config.v1.AccountsEmail";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "smtp", kind: "message", T: SMTP, oneof: "op" },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AccountsEmail {
    return new AccountsEmail().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AccountsEmail {
    return new AccountsEmail().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AccountsEmail {
    return new AccountsEmail().fromJsonString(jsonString, options);
  }

  static equals(a: AccountsEmail | PlainMessage<AccountsEmail> | undefined, b: AccountsEmail | PlainMessage<AccountsEmail> | undefined): boolean {
    return proto3.util.equals(AccountsEmail, a, b);
  }
}

/**
 * @generated from message config.v1.SMTP
 */
export class SMTP extends Message<SMTP> {
  /**
   * @generated from oneof config.v1.SMTP.op
   */
  op: {
    /**
     * @generated from field: config.v1.StringOp host = 1;
     */
    value: StringOp;
    case: "host";
  } | {
    /**
     * @generated from field: config.v1.UInt64Op port = 2;
     */
    value: UInt64Op;
    case: "port";
  } | {
    /**
     * @generated from field: config.v1.StringOp user = 3;
     */
    value: StringOp;
    case: "user";
  } | {
    /**
     * @generated from field: config.v1.StringOp pass = 4;
     */
    value: StringOp;
    case: "pass";
  } | {
    /**
     * @generated from field: config.v1.StringOp from = 5;
     */
    value: StringOp;
    case: "from";
  } | { case: undefined; value?: undefined } = { case: undefined };

  constructor(data?: PartialMessage<SMTP>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "config.v1.SMTP";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "host", kind: "message", T: StringOp, oneof: "op" },
    { no: 2, name: "port", kind: "message", T: UInt64Op, oneof: "op" },
    { no: 3, name: "user", kind: "message", T: StringOp, oneof: "op" },
    { no: 4, name: "pass", kind: "message", T: StringOp, oneof: "op" },
    { no: 5, name: "from", kind: "message", T: StringOp, oneof: "op" },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SMTP {
    return new SMTP().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SMTP {
    return new SMTP().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SMTP {
    return new SMTP().fromJsonString(jsonString, options);
  }
