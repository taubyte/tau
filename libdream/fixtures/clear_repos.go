...
func init() {
	libdream.RegisterFixture("clearRepos", clearRepos)
}

func clearRepos(u *libdream.Universe, params ...interface{}) error {
	if len(params) > 0 {
...
func githubApiClient(u *libdream.Universe, token string) *github.Client {
